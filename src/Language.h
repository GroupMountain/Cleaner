...
std::string en_US = R"(
    ...
    cleaner.form.common.button=%1$s (%2$s)
    cleaner.form.common.search=Search
    cleaner.form.common.back=Back
    ...
    cleaner.form.unload.update=Start to update. Cleaner will notify you after completing
    ...
    cleaner.form.setting.cleanItemAge=Clean Fresh Items
    cleaner.form.setting.cleanItemType=Clean Config-Protected Items
    cleaner.form.setting.cleanEffectArrow=Clean Tipped Arrow
...
std::string zh_CN = R"(
    ...
    cleaner.form.common.button=%1$s (%2$s个)
    cleaner.form.common.search=搜索
    cleaner.form.common.back=返回
    cleaner.form.runtime.title=§g§lCleaner§r-已加载生物管理
    cleaner.form.runtime.content=选择你要清理的已加载生物:
    cleaner.form.unload.title=§g§lCleaner§r-未加载生物管理
    ...
    cleaner.form.unload.update=更新已开始，完成更新后将在信息栏通知您
    ...
    cleaner.form.setting.cleanEffectArrow=清理药水箭
